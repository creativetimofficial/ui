...
- **Navbar Design**: Sleek, dark, rounded pill-shaped navigation with logo and nav links (Docs, Examples) on left separated by vertical line, search, GitHub link, theme switcher, and Get Started button on right.
