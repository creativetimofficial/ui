...
description: Troubleshooting ElevenLabs UI components.
---
...
## I ran the ElevenLabs UI CLI but nothing was added to my project
...
- You're using the latest version of the ElevenLabs UI CLI:
