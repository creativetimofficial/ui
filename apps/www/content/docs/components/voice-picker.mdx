---
title: Voice Picker
description: Searchable voice selector with audio preview, orb visualization, and voice API integration.
featured: true
component: true
---
...
```bash
npx @creative-tim/ui@latest components add voice-picker
```
