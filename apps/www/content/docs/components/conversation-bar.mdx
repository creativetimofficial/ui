...
description: A complete voice conversation interface with microphone controls, text input, and real-time waveform visualization for voice agents.
featured: true
component: true
---
...
```bash
npx @creative-tim/ui@latest components add conversation-bar
```
...
<Callout type="info">
  This component requires an Agent ID. [Create your agent
  here](https://creative-tim.com/agents?utm_source=ui_creative-tim&utm_medium=web&utm_campaign=growth_experiments_ui_components).
</Callout>
...
- **Voice Input**: Connect to voice agents via WebRTC for real-time voice conversations
