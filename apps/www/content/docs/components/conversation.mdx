...
```bash
npx @creative-tim/ui@latest components add conversation
```
...
- This component is inspired by Vercel's [AI SDK Conversation component](https://ai-sdk.dev/elements/components/conversation) with modifications for Creative Tim UI
