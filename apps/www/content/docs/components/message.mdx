...
```bash
npx @creative-tim/ui@latest components add message
```
...
- This component is inspired by Vercel's [AI SDK Message component](https://ai-sdk.dev/elements/components/message) with modifications for Creative Tim UI
