...
```bash
npx @creative-tim/ui@latest components add response
```
...
- This component is inspired by Vercel's [AI SDK Response component](https://ai-sdk.dev/elements/components/response) with modifications for Creative Tim UI
