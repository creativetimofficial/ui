    ...
    <section className="py-16">
      <div className="container mx-auto grid gap-10 md:grid-cols-2 grid-cols-1">
        <div>
          <div>
            <img
              alt="Product"
              src={active}
              className="h-auto w-full max-w-full border rounded-lg object-cover object-center"
            />
          </div>
        ...
        <div>
          ...
          <h3 className="text-lg font-semibold my-4">Color</h3>
          ...
          <Accordion type="single" defaultValue="one" collapsible className="w-full">
